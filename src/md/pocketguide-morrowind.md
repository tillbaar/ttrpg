---
layout: base.njk
title: Pocket Guide to the Empire - Morrowind
---
...
<div
  ...
  style="background-image: url('{{ '/images/tamriel.webp' | url }}');
    ...
    --map-size: 225% auto; --map-position: 98.0% 21.25%;">
</div>
    <svg viewBox="0 0 1000 1000" class="map-overlay">
      ...
      <text x="-50" y="112.5"
        ...
        paint-order="stroke fill">Skyrim</text>
      <desc>CITY NAMES ----------------------------------------- </desc>
      <circle cx="480" cy="325" r="6.25" fill="var(--heading-color)"/>
      <text x="480" y="305"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Ald'ruhn</text>
      <circle cx="623.75" cy="972.5" r="6.25" fill="var(--heading-color)"/>
      <text x="623.75" y="952.5"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Almalexia</text>
      <circle cx="195" cy="132.5" r="6.25" fill="var(--heading-color)"/>
      <text x="195" y="112.5"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Baan Malur</text>
      <circle cx="477.5" cy="442.5" r="6.25" fill="var(--heading-color)"/>
      <text x="477.5" y="422.5"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Balmora</text>
      <circle cx="795" cy="216.25" r="6.25" fill="var(--heading-color)"/>
      <text x="795" y="196.25"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Firewatch</text>
      <circle cx="345" cy="248.75" r="6.25" fill="var(--heading-color)"/>
      <text x="345" y="228.75"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Gnisis</text>
      <circle cx="385" cy="835" r="6.25" fill="var(--heading-color)"/>
      <text x="385" y="815"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Kragenmoor</text>
      <circle cx="1060" cy="562.5" r="6.25" fill="var(--heading-color)"/>
      <text x="1060" y="542.5"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Necrom</text>
      <circle cx="770" cy="353.75" r="6.25" fill="var(--heading-color)"/>
      <text x="770" y="323.75"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Sadrith Mora</text>
      <circle cx="576.25" cy="612.5" r="6.25" fill="var(--heading-color)"/>
      <text x="576.25" y="592.5"
        class="imglab" font-size="36" text-anchor="middle" stroke-width="5px"
        stroke="var(--body-bg-color)" paint-order="stroke fill">
        Vivec</text>
  </svg>
...
